...
1. On the **Dashboard**, scroll down and change the **Language** dropdown to **日本語**. This only changes the app's own admin language, not your store's customer-facing default language.

![Default text is now prefilled in Japanese](../img/04-default-text-japanese-prefill-annotated.png)

2. Open **Content & Translation** again — every field on the Default Text tab is now filled in with Japanese copy automatically; the **Box items title** field, for example, now reads **景品一覧** instead of "Box items". Edit any one field slightly (for example, add a space) and click **Save** to keep this Japanese text.
...
![Translate into your store's other languages](../img/03-translation-french-annotated.png)
