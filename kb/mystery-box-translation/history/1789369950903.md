...
![Edit the default text (English)](../img/02-default-text-english-annotated.png)
...
## 3. Optional: switch the app's language to Japanese

![Optional: switch the app's language to Japanese](../img/03-dashboard-language-english-annotated.png)

Mystery Box Builder can prefill the Default Text tab with ready-made Japanese copy. On the **Dashboard**, scroll down and change the **Language** dropdown to **日本語**. This only changes the app's own admin language, not your store's customer-facing default language.

## 4. Default text is now prefilled in Japanese

![Default text is now prefilled in Japanese](../img/04-default-text-japanese-prefill-annotated.png)

Open **Content & Translation** again. Every field on the Default Text tab is now filled in with Japanese copy automatically — the **Box items title** field below now reads **景品一覧** instead of "Box items". Edit any one field slightly (for example, add a space) and click **Save** to keep this Japanese text.
...
## 5. Translate into your store's other languages

![Translate into your store's other languages](../img/05-translation-french-annotated.png)
